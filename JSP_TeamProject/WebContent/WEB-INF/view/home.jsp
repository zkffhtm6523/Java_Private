...
@font-face {font-family: 'GmarketSansMedium';src: url('https://cdn.jsdelivr.net/gh/projectnoonnu/noonfonts_2001@1.1/GmarketSansMedium.woff') format('woff');font-weight: normal;font-style: normal;}
	...
	#logo{width: 250px; cursor: pointer; float: left; height: 80px; margin-left: 40px;}
...
<body>
	<div class="container">
		<div class="header">
			<img alt="모두의 웹툰" src="/images/logo2.png" id="logo"
				onclick="goHome()">
			<!-- 사이트 대표 아이콘 홈으로 돌아오는 링크 -->
			<div class="topMenu">
				<input type="search" id="search" placeholder="웹툰, 작가를 검색하세요"
	...
	<section>
		<div class="indexBlock" style="margin-bottom: 30px;">
			...
			<span class="material-icons">keyboard_arrow_left</span>
				<c:forEach items="${naverList}" var="item" begin="0" end="4">
		...
		<div class="indexBlock">
			...
			<div class="listBlock">
			<span class="material-icons">keyboard_arrow_left</span>
				<c:forEach items="${kakaoList}" var="item" begin="0" end="4">
		...
		<div class="indexBlock">
			...
			<div class="listBlock">
			<span class="material-icons">keyboard_arrow_left</span>
				<c:forEach items="${lezhinList}" var="item" begin="10" end="14">
